...
const NewMealForm: React.FC<NewMealFormProps> = ({ onClose, mealInfo }) => 
{
    ...
    return (
        <div className="fixed inset-0 z-50 flex md:flex-row flex-col items-center md:justify-center  backdrop-blur-3xl p-4 pb-10 overflow-auto sm:items-start md:items-center">
